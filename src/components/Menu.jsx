        ...
        <>
            ...
            <div className={`z-10 fixed top-0 right-0 bottom-0 bg-white transition-all overflow-hidden flex flex-col ${
                ...
                <div className="flex-1 flex items-start justify-center flex-col gap-6 p-8">
                    <MenuButton label="A propos" onClick={() => onSectionChange(0)}/>
                    <MenuButton label="Competences" onClick={() => onSectionChange(1)}/>
                    <MenuButton label="Projets" onClick={() => onSectionChange(2)}/>
